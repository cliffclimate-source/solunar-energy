...
import { productsMeta, products, productsSoftware, productsNote } from '@/content/pages/products';
        ...
        <Container>
          <Reveal>
            <div className="max-w-2xl">
              ...
              <p className="mt-4 prose-body">
                Every Solunar system is monitored and managed in software — control strategy on site
                and oversight in the cloud.
              </p>
            </div>
          </Reveal>
